...
class CarWebsiteApp:
    """Car Website - A system to help launch and manage the open-source project 'car website'.
    ...
    def show_welcome(self) -> None:
        ...
        print(f"==================================================")
        print(f"\nProblem Solved: A system to help launch and manage the open-source project 'car website'.")
        print(f"\nCore Features:")
